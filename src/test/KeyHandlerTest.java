...
public class KeyHandlerTest {
    /**
     * KeyHandler object, 
     * used for catching the KeyEvent
     */
    public KeyHandler keyHdl;
    /**
     * KeyEvent object,
     * used for simulating the human action of pressing the key
     */
    public KeyEvent keyEvnt;
    /**
     * JFrame object,
     * used as source for the key event 
     */
    public JFrame frame;
    /**
     * ObserverTest
     * object for simulating the keyhandler's observer
     */
    ...
    public class ObserverTest implements Observer{
         ...
         * Select the action related to the key pressed
         */
        @Override
    ...
    public void testKeyPressedX(){
     ...
     /**
     * Test for checking that 
     * if a no-mapped key has been pressed then the aspected value must be different
